...
def make_move(tic_tac_toe_game:TicTacToe.TicTacToeGame, QTable:QTable.QTable_TicTacToe, player, random_ratio):
    ...
    [action, old_Qvalue] = QTable.max_action_value(tic_tac_toe_game)
...
def update_QTable_after_move(QTable:QTable.QTable_TicTacToe, old_state, old_value, action, tic_tac_toe_game:TicTacToe.TicTacToeGame, player, opponent):
